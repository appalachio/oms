...
group :development, :test do
  ...
  # Rubocop is used to enforce code styles
  gem 'rubocop', require: false
  # Adds Rails specific checks to Rubocop
  gem 'rubocop-rails', require: false
  # Adds Rake task specific checks to Rubocop
  gem 'rubocop-rake', require: false
  # Adds performance specific checks to Rubocop
  gem 'rubocop-performance', require: false
  # Adds i18n specific checks to Rubocop
  gem 'rubocop-i18n', require: false
  # Adds RSpec specific checks to Rubocop
  gem 'rubocop-rspec', require: false
  # Adds Factory Bot specific checks to Rubocop
